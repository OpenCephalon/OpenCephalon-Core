 ...
 * @ORM\Entity(repositoryClass="OpenCephalonBundle\Repository\SourceRepository")
 * @ORM\Table(name="source", uniqueConstraints={@ORM\UniqueConstraint(name="source_public_id", columns={"project_id", "public_id"})})
